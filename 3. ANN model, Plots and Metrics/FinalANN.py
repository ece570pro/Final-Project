...
# Apply custom scaling to the common splits
...
# Save the k11 model
model_k11.save('saved_model/my_model_k11.keras')
...
# Save the k33 model
model_k33.save('saved_model/my_model_k33.keras')
